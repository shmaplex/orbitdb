...
describe("Log - CRDT", () => {
  ...
  describe("is a CRDT", () => {
    ...
    it("join is associative", async () => {
      ...
      deepStrictEqual(
        res1.map((e: any) => e.hash),
        res2.map((e: any) => e.hash)
      );
    });
    ...
    it("multiple joins are commutative", async () => {
      ...
      deepStrictEqual(
        resA1.map((e: any) => e.hash),
        resA2.map((e: any) => e.hash)
      );
      ...
      deepStrictEqual(
        resB1.map((e: any) => e.hash),
        resB2.map((e: any) => e.hash)
      );
      ...
      deepStrictEqual(
        resC1.map((e: any) => e.hash),
        resC2.map((e: any) => e.hash)
      );
      ...
      deepStrictEqual(
        resD1.map((e: any) => e.hash),
        resD2.map((e: any) => e.hash)
      );
      ...
      deepStrictEqual(
        logLeft.map((e: any) => e.hash),
        logRight.map((e: any) => e.hash)
      );
    });
